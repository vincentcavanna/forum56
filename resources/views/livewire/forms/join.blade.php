<div>
    <p x-show="$wire.submitted" class="text-2xl font-bold">Thank you {{ $first_name }} for joining Forum56!</p>
    <form wire:submit="save" class="flex flex-col">
        ...
        <x-forms.styled-input name="interests" label="Interests"
                              ...
                              model="interests"/>
        <button @class(["my-2 rounded bg-contrast-dark text-white p-3", "bg-gray" => $submitted]) @disabled($submitted) type="submit">
            Submit
        </button>
    </form>
</div>